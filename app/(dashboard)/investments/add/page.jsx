// app/(dashboard)/investments/add/page.jsx
...
import { createInvestment } from "@/store/actions/investmentsActions";
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100 dark:border-white/[0.06]">
          ...
          <div>
            <h2 className="text-base font-black text-foreground">Investment Information</h2>
