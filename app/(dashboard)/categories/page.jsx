...
export default function CategoriesPage() {
  ...
  const handleArchiveConfirm = async () => {
    ...
    try {
      ...
      if (res?.success) {
        toast.success(
          action === "archive"
            ? t("categories.categoryArchived")
            : t("categories.categoryUnarchived")
        );
      } else {
  ...
  const totalFromStats = stats?.totalCategories ?? stats?.total ?? total;
  const activeFromStats = stats?.activeCategories ?? stats?.active ?? activeCount;
  const archivedFromStats = stats?.archivedCategories ?? stats?.archived ?? archivedCount;
  ...
  return (
    <div className="space-y-5">
            ...
            <EmptyState
              ...
              description={
                searchQuery
                  ...
                  : activeTab === "archived"
                  ? t("categories.noArchivedCategories")
                  : activeTab === "active"
                  ? t("categories.noActiveCategories")
      ...
      <ConfirmDialog
        ...
        title={
          archiveDialog.action === "archive"
            ...
            : t("categories.unarchiveCategory")
        }
        description={
          archiveDialog.item
            ? `${
      ...
      <ConfirmDialog
        ...
        description={
          deleteDialog.item
            ? `${t("categories.deleteCategoryDesc")} "${getDisplayName(deleteDialog.item)}"${t("categories.deleteSuffix")}`
            : t("categories.areYouSure")
        }
