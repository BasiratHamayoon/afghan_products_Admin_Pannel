...
export default function ConsultancyPage() {
  ...
  const avgRating =
    safeConsultants.length > 0
      ? (
          safeConsultants.reduce((a, c) => a + (c.rating || 0), 0) /
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl bg-white dark:bg-[#0f1420] border border-gray-100 dark:border-white/[0.06] shadow-[0_2px_12px_rgba(15,105,176,0.06)] overflow-hidden">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex-1 min-w-[180px]">
              <SearchInput
                ...
                placeholder={t("consultancy.searchPlaceholder")}
              />
            </div>
            {searchQuery && (
              <button
            ...
            <p className="text-[11px] text-muted-foreground font-medium">
              ...
              {filteredConsultants.length !== 1
                ? t("consultancy.resultsPlural")
                : t("consultancy.results")}
            </p>
          </div>
        </div>
        ...
        <div className="p-4">
          {isLoading ? (
            <LoadingSpinner
              size="lg"
              text={t("consultancy.loadingConsultants")}
              className="py-16"
            />
            ...
            <EmptyState
              ...
              description={
                searchQuery
                  ? t("consultancy.tryAdjustingSearch")
                  : t("consultancy.addFirstConsultant")
              }
              action={
      ...
      <ConfirmDialog
        ...
        description={
          deleteDialog.item
            ? `${t("consultancy.deleteConsultantDesc")} "${getDisplayName(deleteDialog.item)}"${t("consultancy.deleteConsultantSuffix")}`
            : t("consultancy.areYouSure")
        }
