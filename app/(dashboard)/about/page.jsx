...
import {
  ...
  BarChart3, FileText, Layers, TrendingUp,
  Edit2, Eye,
} from "lucide-react";
  ...
  return (
    <div className="space-y-5">
        ...
        {isLoading ? (
          ...
          <div className="p-8">
            <EmptyState
              ...
              description="Create your about page content to get started"
              action={
                <button
                  onClick={() => router.push("/about/add")}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2 flex-wrap">
                    ...
                    >
                      {aboutItem.isActive ? "Active" : "Inactive"}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium">
                      Updated {formatDate(aboutItem.updatedAt)}
                    </span>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2 shrink-0 flex-wrap">
                ...
                <button
                  onClick={() =>
                    router.push(`/about/add?edit=${aboutItem.id}`)
                  }
                ...
                <button
                  onClick={() =>
                    setDeleteDialog({ open: true, item: aboutItem })
                  }
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to permanently delete "${deleteDialog.item?.headline}"? This cannot be undone.`}
        confirmLabel="Delete"
