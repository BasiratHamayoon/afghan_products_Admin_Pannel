...
function AddContactContent() {
  ...
  useEffect(() => {
    ...
    if (co) {
      setLabel(getFieldValue(co, "labelMultilingual", "label"));
      setIcon(co.icon || "");
  ...
  }, [editId, contactOptions, currentLang]);
  ...
  const handleSubmit = async (e) => {
    ...
    const errs = {};
    if (!label.trim()) errs.label = t("helpCenter.contactTitleRequired");
    if (!type) errs.type = t("helpCenter.typeRequired") || "Type is required";
    if (!value.trim())
      errs.value = t("helpCenter.valueRequired") || "Value is required";
  ...
  const pageTitle = isEditMode
    ? t("helpCenter.editContactTitle")
    : t("helpCenter.addContactTitle");
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-foreground uppercase tracking-widest">
                {t("helpCenter.contactTitleLabel")}{" "}
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder={t("helpCenter.contactIconPlaceholder")}
                disabled={isLoading}
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  {isEditMode
                    ? t("helpCenter.updateContactBtn")
                    : t("helpCenter.addContactBtn")}
                </>
              )}
            </button>
          </div>
