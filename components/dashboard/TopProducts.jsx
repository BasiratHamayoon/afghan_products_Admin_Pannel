            ...
            <tbody>
              {topProducts.map((product, i) => {
                ...
                const growth =
                  ...
                  null;
                const id =
                  product.id || product._id || String(i + 1);
                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground font-medium mt-0.5">
                            SKU #{String(id).padStart(4, "0").slice(-4)}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-4 px-4">
                      {growth !== null ? (
                        <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl text-[11px] font-bold bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400">
