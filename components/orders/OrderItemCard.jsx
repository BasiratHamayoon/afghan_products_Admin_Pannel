      ...
      <div className="flex-1 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-3 mt-1.5 flex-wrap">
              ...
              <div className="flex items-center gap-1 text-xs text-muted-foreground font-medium">
                ...
                AFN {Number(item.unitPrice).toLocaleString()} each
              </div>
              <div className="flex items-center gap-1 text-xs font-bold text-foreground">
                <DollarSign className="h-3 w-3 text-[#0F69B0]" />
        ...
        {item.sellerName && (
          <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-100 dark:border-white/[0.04]">
            <div
              className="h-6 w-6 rounded-full flex items-center justify-center text-[8px] font-black text-white shrink-0"
              style={{
                background:
