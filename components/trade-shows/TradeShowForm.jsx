        ...
        <div className="grid grid-cols-1 gap-5">
          <div className="space-y-1.5">
            ...
            {!displayImage ? (
              <button
                ...
                disabled={isLoading}
                className="w-full flex flex-col items-center justify-center gap-2 py-8 rounded-xl border-2 border-dashed border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.02] hover:border-[#0F69B0]/40 hover:bg-[#0F69B0]/[0.02] transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
              >
              ...
              <div className="relative w-full h-40 rounded-xl overflow-hidden border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.04]">
                ...
                <div className="absolute top-2 end-2 flex items-center gap-1.5">
                  <button
                    ...
                    onClick={() => coverImageRef.current?.click()}
                    disabled={isLoading}
                    className="h-7 px-2.5 rounded-lg bg-black/50 flex items-center justify-center text-white text-[10px] font-bold hover:bg-black/70 transition-colors cursor-pointer disabled:opacity-60"
                  >
                    Change
                  </button>
                  <button
                    ...
                    disabled={isLoading}
                    className="h-7 w-7 rounded-lg bg-red-500/90 flex items-center justify-center text-white hover:bg-red-500 transition-colors cursor-pointer disabled:opacity-60"
                  >
                ...
                {imageFile && (
                  <div className="absolute bottom-1 start-1">
                    <p className="text-[9px] text-white bg-black/50 rounded px-1 py-0.5">
                      {imageFile.name}
                    </p>
                  </div>
                )}
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-1.5 px-4 py-3 rounded-xl text-xs font-bold text-[#0F69B0] hover:bg-[#0F69B0]/[0.08] transition-colors cursor-pointer border border-[#0F69B0]/20 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <Plus className="h-3.5 w-3.5" />
              {t("tradeShows.add") || "Add Images"}
            </button>
            ...
            {galleryItems.length > 0 ? (
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 mt-3">
                ...
                <button
                  ...
                  onClick={() => galleryInputRef.current?.click()}
                  disabled={isLoading}
                  className="h-28 rounded-xl border-2 border-dashed border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.02] hover:border-[#0F69B0]/40 hover:bg-[#0F69B0]/[0.02] transition-all flex flex-col items-center justify-center gap-1.5 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                >
              ...
              <button
                ...
                onClick={() => galleryInputRef.current?.click()}
                disabled={isLoading}
                className="w-full flex flex-col items-center justify-center py-6 border-2 border-dashed border-gray-200 dark:border-white/[0.08] rounded-xl mt-2 hover:border-[#0F69B0]/40 hover:bg-[#0F69B0]/[0.02] transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <ImageIcon className="h-8 w-8 text-muted-foreground/30 mb-2" />
                <p className="text-xs text-muted-foreground font-medium">
                  {t("tradeShows.noGalleryImages")}
                </p>
            ...
            <p className="text-[10px] text-muted-foreground font-medium">
              ...
              {galleryItems.length !== 1
                ? t("tradeShows.galleryCountPlural")
                : t("tradeShows.galleryCount")}{" "}
              {t("tradeShows.inGallery")}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input
              type="text"
              value={country}
              onChange={(e) => { setCountry(e.target.value); clearErr("country"); }}
              placeholder={t("tradeShows.countryPlaceholder")}
              disabled={isLoading}
              className={inputClass(errors.country)}
            />
            {errors.country && (
              <p className="text-[11px] text-red-500 font-semibold">{errors.country}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder={t("tradeShows.cityPlaceholder")}
              disabled={isLoading}
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder={t("tradeShows.venuePlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder={t("tradeShows.addressPlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder={t("tradeShows.organizerNamePlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-foreground uppercase tracking-widest">
              {t("tradeShows.organizerEmail")}
            </label>
            <input
              type="email"
              value={organizerEmail}
              onChange={(e) => setOrganizerEmail(e.target.value)}
              placeholder={t("tradeShows.organizerEmailPlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-foreground uppercase tracking-widest">
              {t("tradeShows.organizerPhone")}
            </label>
            <input
              type="text"
              value={organizerPhone}
              onChange={(e) => setOrganizerPhone(e.target.value)}
              placeholder={t("tradeShows.organizerPhonePlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-foreground uppercase tracking-widest">
              {t("tradeShows.website")}
            </label>
            <input
              type="text"
              value={website}
              onChange={(e) => setWebsite(e.target.value)}
              placeholder={t("tradeShows.websitePlaceholder")}
              disabled={isLoading}
              className={inputClass()}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.02]">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground font-medium">
                {isActive ? t("tradeShows.activeVisible") : t("tradeShows.activeHidden")}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.02]">
            <button
              ...
              className={cn(
                "relative w-11 h-6 rounded-full transition-all cursor-pointer flex-shrink-0 disabled:opacity-60",
                isFeatured ? "bg-amber-500" : "bg-gray-300 dark:bg-white/20"
              )}
            >
              <span
                className={cn(
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground font-medium">
                {isFeatured ? t("tradeShows.featuredHighlighted") : t("tradeShows.featuredNormal")}
              </p>
            </div>
          </div>
        </div>
        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              {safe.id || safe._id ? t("tradeShows.update") : t("tradeShows.create")}
            </>
          )}
        </button>
      </div>
