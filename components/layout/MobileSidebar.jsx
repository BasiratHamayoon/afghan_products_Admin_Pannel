            ...
            >
              ...
              >
                <button
                  ...
                  className="flex items-center gap-3 h-10 w-full px-3 rounded-xl text-red-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 text-[13px] font-semibold cursor-pointer"
                >
                  <div
