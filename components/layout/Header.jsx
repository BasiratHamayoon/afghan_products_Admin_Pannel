...
import { Bell, Search, Menu, X, PanelLeftOpen } from "lucide-react";
          ...
          <AnimatePresence>
            {showNotifications && (
              <motion.div
                ...
                className="absolute right-0 top-12 w-80 rounded-2xl overflow-hidden z-50 bg-white dark:bg-[#0f1420]"
                style={{
                  border: "1px solid rgba(15,105,176,0.1)",
              ...
              >
                ...
                >
                  ...
                  <button className="text-[11px] font-bold cursor-pointer text-[#0F69B0] hover:underline">
                    Mark all read
                  </button>
                </div>
                <div className="max-h-64 overflow-y-auto">
                  {notifications.map((notif) => (
                    <div
                      key={notif.id}
                      className="px-4 py-3 cursor-pointer transition-colors hover:bg-blue-50/40 dark:hover:bg-white/[0.03]"
                      style={{
            ...
            {showProfile && (
              ...
              >
                ...
                <div className="py-1.5" style={{ borderTop: "1px solid rgba(15,105,176,0.07)" }}>
                  <motion.button
                    whileHover={{ x: 3 }}
                    className="w-full text-left px-4 py-2.5 text-xs font-semibold text-red-500 cursor-pointer hover:bg-red-50/60 dark:hover:bg-red-900/20 transition-colors"
                  >
                    Sign Out
                  </motion.button>
                </div>
