          ...
          {safeItems.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-4 px-4">
                  <span className="text-[11px] font-bold px-2.5 py-1 rounded-lg bg-purple-500/10 text-purple-600 whitespace-nowrap capitalize">
                ...
                <td className="py-4 px-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-medium text-muted-foreground whitespace-nowrap">
                      {formatAmount(item.investmentRangeMin)} -{" "}
                      {formatAmount(item.investmentRangeMax)}
                    </span>
                  </div>
                </td>
