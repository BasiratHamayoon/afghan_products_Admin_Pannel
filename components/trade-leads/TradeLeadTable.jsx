...
export default function TradeLeadTable({ leads = [], onView, onDelete, onUpdateStatus }) {
  ...
  const urgencyConfig = {
    HIGH: {
      label: t("tradeLeads.urgencyHigh"),
      bg: "bg-red-500/10",
      text: "text-red-500",
      dot: "bg-red-500",
    },
    MEDIUM: {
      label: t("tradeLeads.urgencyMedium"),
      bg: "bg-amber-500/10",
      text: "text-amber-600",
      dot: "bg-amber-500",
    },
    LOW: {
      label: t("tradeLeads.urgencyLow"),
  ...
  const statusConfig = {
    ...
    EXPIRED: {
      label: t("tradeLeads.statusExpired"),
      bg: "bg-gray-500/10",
      text: "text-gray-500",
      dot: "bg-gray-400",
    },
        ...
        <tbody>
          {safeLeads.map((lead, i) => {
            ...
            const displayProductName =
              resolveField(lead.productNameMultilingual, lead.productName, lang) || "—";

            const displayCategoryName =
              resolveField(lead.categoryNameMultilingual, lead.categoryName, lang) || "—";

            const displayLocation =
              resolveField(lead.locationMultilingual, lead.location, lang) || "—";

            const displayDescription =
              resolveField(
                lead.detailDescriptionMultilingual,
