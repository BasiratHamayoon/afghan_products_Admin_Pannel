...
export default function SuccessStoryForm({ initialData, onSubmit, onCancel, isLoading }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!profilePicture.trim()) errs.profilePicture = t("successStories.profilePictureRequired");
    ...
    <motion.form initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} onSubmit={handleSubmit} className="space-y-8">
      <div>
        <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-4 flex items-center gap-2">
          <span className="h-1.5 w-1.5 rounded-full bg-[#0F69B0]" />{t("successStories.personInformation")}
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input type="text" value={fullName} onChange={(e) => { setFullName(e.target.value); clearErr("fullName"); }} placeholder={t("successStories.fullNamePlaceholder")} disabled={isLoading} className={inputClass(errors.fullName)} />
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" value={companyName} onChange={(e) => { setCompanyName(e.target.value); clearErr("companyName"); }} placeholder={t("successStories.companyNamePlaceholder")} disabled={isLoading} className={inputClass(errors.companyName)} />
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" value={profilePicture} onChange={(e) => { setProfilePicture(e.target.value); clearErr("profilePicture"); }} placeholder={t("successStories.profilePicturePlaceholder")} disabled={isLoading} className={inputClass(errors.profilePicture)} />
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" value={location} onChange={(e) => { setLocation(e.target.value); clearErr("location"); }} placeholder={t("successStories.locationPlaceholder")} disabled={isLoading} className={inputClass(errors.location)} />
      ...
      <div>
        <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-4 flex items-center gap-2">
          <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />{t("successStories.storySection")}
        </h3>
        <div className="space-y-5">
          <div className="space-y-1.5">
            ...
            <textarea value={story} onChange={(e) => { setStory(e.target.value); clearErr("story"); }} rows={5} placeholder={t("successStories.successStoryPlaceholder")} disabled={isLoading} className={cn(inputClass(errors.story), "resize-none")} />
      ...
      <div>
        <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-4 flex items-center gap-2">
          <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />{t("successStories.ratingAndSettings")}
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="space-y-1.5">
