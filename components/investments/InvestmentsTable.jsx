...
import {
  Eye, Trash2, CheckCircle, XCircle, Clock,
...
const RISK_CONFIG = {
  low: { label: "Low", cls: "bg-emerald-500/10 text-emerald-600" },
            ...
            return (
              ...
              >
                ...
                <td className="py-4 px-4">
                  <span
                    className={cn(
                      "text-[11px] font-bold px-2.5 py-1 rounded-lg whitespace-nowrap",
                      risk.cls
                    )}
                  >
                    {risk.label}
                ...
                <td className="py-4 px-4">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium">
                      Raised: {formatAmount(item.raisedAmount)}
                    </p>
                  </div>
                </td>
