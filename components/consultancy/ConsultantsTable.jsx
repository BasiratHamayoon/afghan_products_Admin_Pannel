          ...
          {safeItems.map((item, i) => {
            ...
            return (
              ...
              >
                <td className="py-4 px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground font-medium mt-0.5 truncate max-w-[140px]">
                        {displayTitle}
                      </p>
                    </div>
                  </div>
                ...
                <td className="py-4 px-4">
                  <span className="text-[11px] font-bold px-2.5 py-1 rounded-lg bg-purple-500/10 text-purple-600 capitalize whitespace-nowrap">
                    {item.specialization || "—"}
                  </span>
                </td>
                <td className="py-4 px-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-medium text-muted-foreground whitespace-nowrap">
                      {item.hourlyRateMin} - {item.hourlyRateMax}/hr
                    </span>
                  </div>
                </td>
                <td className="py-4 px-4">
                ...
                <td className="py-4 px-4">
                  <span className="text-sm font-bold text-foreground">{item.totalSessions}</span>
                </td>
                <td className="py-4 px-4">
                  <div className="flex items-center gap-1 flex-wrap max-w-[100px]">
                    {item.languages?.slice(0, 2).map((l, j) => (
                      <span
                        key={j}
                        className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-gray-100 dark:bg-white/[0.06] text-muted-foreground"
                      >
                        {l}
                      </span>
                    ))}
