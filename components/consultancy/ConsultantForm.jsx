...
export default function ConsultantForm({ initialData, onSubmit, onCancel, isLoading }) {
  ...
  const [name, setName] = useState(getFieldValue("nameMultilingual", "name"));
    ...
    >
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="space-y-1.5">
            ...
            {errors.specialization && (
              <p className="text-[11px] text-red-500 font-semibold">{errors.specialization}</p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            {errors.hourlyRateMin && (
              <p className="text-[11px] text-red-500 font-semibold">{errors.hourlyRateMin}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.hourlyRateMax && (
              <p className="text-[11px] text-red-500 font-semibold">{errors.hourlyRateMax}</p>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.02] lg:col-span-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground font-medium">
                {isActive ? t("consultancy.visibleToUsers") : t("consultancy.hidden")}
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        {imagePreview ? (
          <div className="relative w-32 h-32 rounded-2xl overflow-hidden border border-gray-200 dark:border-white/[0.08] group">
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
              <button
                ...
                disabled={isLoading}
                className="h-8 w-8 rounded-lg bg-white/90 flex items-center justify-center cursor-pointer"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="h-8 w-8 rounded-lg bg-red-500/90 flex items-center justify-center cursor-pointer"
              >
          ...
          <label
            htmlFor="consultant-image-upload"
            className="flex flex-col items-center justify-center w-48 h-32 rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/[0.08] hover:border-[#0F69B0]/40 hover:bg-[#0F69B0]/[0.02] transition-all cursor-pointer"
          >
